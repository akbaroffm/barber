<template>
  <div class="pb-24">
    ...
    <div class="px-4 pt-2">
        ...
        >
          <div class="flex justify-between items-center">
            ...
            <label class="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div
                class="w-[46px] h-[26px] rounded-full peer peer-checked:after:translate-x-[20px] after:content-[''] after:absolute after:top-[3px] after:left-[3px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all shadow-sm"
                :style="{
                  background: day.active ? 'var(--accent)' : '#2a2117',
                }"
              />
            </label>
          </div>
          ...
          <transition name="expand">
            <div
              v-if="day.active"
              class="flex items-center gap-4 mt-4 pt-4"
              style="border-top: 1px solid #ffffff05"
            >
              <div class="flex-1 flex flex-col gap-1.5" style="min-width: 0;">
                ...
                <div class="relative">
                  ...
                  <input
                    v-model="day.start"
                    type="time"
                    class="w-full py-2.5 rounded-xl text-[14px] font-bold"
                    style="background: var(--bg-primary); border: none; padding-left: 36px; max-width: 100%; box-sizing: border-box;"
                  />
                </div>
              </div>
      ...
      <button
        @click="saveSchedule"
        class="w-full py-4 rounded-[20px] text-[15px] font-bold mt-6 shadow-xl flex items-center justify-center gap-2"
