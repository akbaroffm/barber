<template>
  <div
    class="min-h-screen flex flex-col px-6 pt-16"
    style="background: var(--bg-primary)"
  >
    <h1 class="text-2xl font-bold mb-1">Xush kelibsiz!</h1>
    <p class="text-[15px] mb-10" style="color: var(--text-secondary)">
      Rolingizni tanlang
    </p>
    ...
    <div class="flex flex-col gap-3">
      ...
      >
        ...
        <div class="flex-1">
          ...
          <span class="text-[13px]" style="color: var(--text-secondary)"
            >Sartarosh qidirish va yozilish</span
          >
        </div>
      ...
      >
        ...
        <div class="flex-1">
          ...
          <span class="text-[13px]" style="color: var(--text-secondary)"
            >Mijozlar va xizmatlarni boshqarish</span
          >
        </div>
        <ChevronRight :size="20" style="color: var(--text-muted)" />
      </button>
